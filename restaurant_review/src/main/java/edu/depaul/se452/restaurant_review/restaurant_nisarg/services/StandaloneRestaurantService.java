...
public class StandaloneRestaurantService {
    ...
    public List<Restaurant> getByName(@PathVariable("restaurant_name") int restaurant_name) {
    ...
    public List<Restaurant> getByName(@PathVariable("restaurant_description") int restaurant_description) {
        List<Restaurant> result = new ArrayList<>();
        for (Restaurant r : allRestaurants.values()) {
    ...
    public List<Restaurant> getByName(@PathVariable("restaurant_location") int restaurant_location) {
        List<Restaurant> result = new ArrayList<>();
        for (Restaurant r : allRestaurants.values()) {
